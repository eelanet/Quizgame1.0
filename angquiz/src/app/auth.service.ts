...
export class AuthService {
  ...
  private apiUrl = 'admin/login'; // autentikaatiopalvelun osoite
  public token: string;
  ...
  private subject2 = new Subject<any>(); // subjectilla viesti categoryyn että token on tullut
        ...
        */
        ...
        if (token) {
          ...
          /* Tässä tutkitaan onko tokenin payloadin sisältö oikea.
             ...
             jolloin käyttäjä pääsee muokkaamaan kategorioita
          */
          try {
            // dekoodataan token
  ...
  /* Ilmoitetaan navbariin ja kategoria komponenttiin että koska ollaan loggauduttu */
  loginTrue(): Observable<any> {
    this.subject.next(true);
    return this.subject.asObservable();
  }

  loginTrueCat(): Observable<any> {
